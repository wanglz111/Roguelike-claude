...
核心功能：
1. 完整的战斗系统（回合制、暴击、装备加成）
2. 丰富的内容池（15 种怪物：11 普通 + 4 Boss，覆盖 1-20 层）
3. 成长系统（经验、升级、属性提升）
4. 装备系统（武器、护甲、属性加成）
5. 背包系统（物品收集、使用、装备）
6. 事件系统（14 个随机事件，多种效果类型，包括永久属性提升）
7. 商店系统（3 种商店类型，购买物品和装备）
8. 存档系统（保存/加载完整游戏状态）
9. Boss 系统（每 5 层出现，特殊挑战）
10. 数值平衡（已测试并调整）
11. 双语支持（中英文）
...
1. 玩家系统：属性、升级、经验、金币
2. 战斗系统：回合制、暴击（10%概率）、装备加成
3. 怪物系统：15 种怪物（11 普通 + 4 Boss），覆盖 1-20 层
4. Boss 系统：每 5 层出现 Boss，特殊提示和更高奖励
5. 背包系统：收集、使用物品
6. 装备系统：武器、护甲、属性加成
7. 事件系统：10 个随机事件（50%触发概率），多种效果类型
8. 商店系统：3 种商店类型（30-50%触发概率），购买药水和装备
9. 存档系统：保存/加载完整游戏状态
10. 数值平衡：已测试 Boss 战和早期生存
11. 双语支持：完整的中英文翻译
12. AI 开发框架：规则、路线图、任务清单
